...
to `catalog-api`. Live database credentials and schema application order belong to
`deployment`, which supplies the runtime driver and connection-pool implementations.
